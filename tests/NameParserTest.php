...
class NameParserTest extends BaseTestCase
{
	...
	/** @test */
	public function it_gets_first_part_of_name_if_no_action_is_guessed()
	{
	...
	public function it_gets_the_correct_matched_results()
	{
	    ...
	    $expected = ['create_users_table', 'users'];
	...
	/** @test */
	public function it_makes_a_regex_pattern_according_to_migration_type()
	{
